...
/**
 * create_buffer - it allocates 1024 bytes of mem for a buffer
 * @file:name of the file that the buffer is storing chars for
...
/**
 * close_file - it cl0ses the file descriptors
...
/**
 * main - it copies file contents to another file
