 ...
 * @e_ident: pointer to an array containing the ELF magic numbrs
...
/**
 * print_version - it prints th3 version of ELF header
 ...
 * @e_type: th3 ELF type
 * @e_ident: point3r to the array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * main - for displaying the info contained in the ELF header at
 * the start of an ELF file
 * @argc: no. of arguments that have been supplied in the program.
 * @argv:the array of pointers to the arguments
 * Return: returns 0 on success
 * Description: !f the file is not an ELF File or the
